...
a persistence unit "holaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "hola/pom.xml":
...
artifact ("hola.war") is already built. You can build
